...
import { CRStoreProvider } from "./interface";

class MemoryCRStoreProvider implements CRStoreProvider {
  ...
  set(items: { [key: string]: any }) {
    // Generally, memory CR store is used for testing, and mocking.
...
export class MemoryCRStore extends BaseCRStore {
  constructor(prefix: string) {
    super(new MemoryCRStoreProvider(), prefix);
  }
}
